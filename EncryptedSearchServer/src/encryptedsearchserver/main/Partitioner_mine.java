...
/*        
    ...
    private void myCenterSelection() {
    	...
    	Matrix C= null;
     try{
    	 C = Matrix.read(new BufferedReader(new FileReader("/home/c00300901/eclipse-workspace/S3BD-JasonThesis/cloud/cloudserver/utilities/aws_cmat.txt")));
    	 //C.print(2, 2);
     }
        catch (IOException e) {
            e.printStackTrace();
...
/*        for (int i =0; i<topCentroids.size();i++)
        ...
        try {
        	br4 = new BufferedReader(new FileReader(new File("/home/c00300901/eclipse-workspace/S3BD-JasonThesis/cloud/cloudserver/utilities/aws_topics.txt")));
...
/*            PriorityQueue<ClusterDistancePair> clusterHeap = new PriorityQueue<ClusterDistancePair>(k, new Comparator<ClusterDistancePair>() {
